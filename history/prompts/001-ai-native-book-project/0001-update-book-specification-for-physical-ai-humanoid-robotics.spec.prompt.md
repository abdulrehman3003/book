---
id: 0001
title: Update book specification for Physical AI & Humanoid Robotics
stage: spec
date: 2025-11-30
surface: agent
model: gemini
...
user: '[USER]'
command: 'Update specs/001-ai-native-book-project/spec.md'
labels: [spec, docs]
links:
...
I have updated the `spec.md` file as requested.
